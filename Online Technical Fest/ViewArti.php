...
mysql_select_db($database_mysql, $mysql);
$query_ManageUsers = "SELECT * FROM register WHERE register.Event = 'ARTI-CODE'";
...
<div id="Content">
<div id="PageHeading">
  <h1 id="Text2">Hi, <?php echo $row_User['Username']; ?>!</h1>
</div>
<div id="ContentLeft">
...
<div id="ContentRight">
 <form id="Form" name="Form" method="post" action="">
    ...
    <tr>
      <td height="31" align="right" valign="top"><pre><strong>Showing: <?php echo ($startRow_ManageUsers + 1) ?>   To :  <?php echo min($startRow_ManageUsers + $maxRows_ManageUsers, $totalRows_ManageUsers) ?>  Of :<?php echo $totalRows_ManageUsers ?>
      </strong></pre></td>
    </tr>
    <tr>
      <td  valign="top">
      <table width="747" bgcolor="#CCCCCC" align="left">
        <tr>
          <td width="243"><strong>Full Name</strong></td>
          <td width="241"><strong>Mobile</strong></td>
          <td width="241"><strong>Email</strong></td>
        </tr>
        </table>
        <strong></br>
        <?php do { ?>
        ...
        <MM_REPEATEDREGION SOURCE="@@rs@@"><MM:DECORATION OUTLINE="Repeat" OUTLINEID=1>
          <table width="747" bgcolor="#CCCCCC" align="left">
            <tr>
              <td width="243"><strong><?php echo $row_ManageUsers['Fname']; ?> <?php echo $row_ManageUsers['Lname']; ?></strong></td>
              <td width="241"><strong><?php echo $row_ManageUsers['Mob']; ?></strong></td>
              <td width="241"><strong><?php echo $row_ManageUsers['Email']; ?></strong></td>
              </tr>
          </table>
          <strong>
