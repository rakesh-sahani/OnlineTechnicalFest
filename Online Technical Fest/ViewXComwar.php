...
mysql_select_db($database_mysql, $mysql);
$query_ManageUsers = "SELECT * FROM register WHERE register.Event = 'X-COMWAR'";
...
<title>View X-COMWAR Users</title>
</head>
<body>
<div id="Holder">
<div id="Header"></div>
...
<div id="ContentRight">
 <form id="Form" name="Form" method="post" action="">
    ...
    <tr>
      <td height="31" align="right" valign="top"><pre><strong>Showing: <?php echo ($startRow_ManageUsers + 1) ?>   To :  <?php echo min($startRow_ManageUsers + $maxRows_ManageUsers, $totalRows_ManageUsers) ?>  Of :<?php echo $totalRows_ManageUsers ?></strong><strong></strong>
      </pre></td>
    </tr>
    <tr>
      <td  valign="top">
      <table width="747" bgcolor="#CCCCCC" align="left">
        ...
        <?php do { ?>
          <table width="747" bgcolor="#CCCCCC" align="left">
            <tr>
              <td width="243"><strong><?php echo $row_ManageUsers['Fname']; ?></strong> <strong><?php echo $row_ManageUsers['Lname']; ?></strong></td>
